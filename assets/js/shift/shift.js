		...
		.validate({
			...
			submitHandler: function () {
				...
				if ($("#uuid").val() == "") {
					// add record
					$.ajax({
						url: baseURL + "ShiftController/create_department",
						type: "POST",
						data: {
					...
					$.ajax({
						url:
							baseURL +
							"ShiftController/update_department/" +
							$("#uuid").val(),
						type: "POST",
						data: {
							department_name: $("#department_name").val(),
...
loadTable = () => {
	...
	$("#data-table").DataTable({
		ajax: {
			url: baseURL + "ShiftController/get_all_shift",
			dataSrc: "",
		},
...
editData = (id, type) => {
	$.ajax({
		url: baseURL + "ShiftController/get_one_shift/" + id,
		// type: "POST",
		dataType: "json",
		success: function (data) {
			formReset("show");
...
deleteData = (id) => {
	Swal.fire({
		...
		if (t.value) {
			$.ajax({
				url: baseURL + "ShiftController/delete_shift/" + id,
				// type: "DELETE",
				// dataType: "json",
				success: function (data) {
					notification(
						"success",
						"Success!",
						"Shift Successfully Deactivated"
					);
					loadTable();
				},
				error: function ({ responseJSON }) {},
